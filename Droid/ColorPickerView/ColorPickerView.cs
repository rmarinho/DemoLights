...
namespace DemoLights.Droid
{
	...
	public class ColorPickerView : ViewGroup //, INotifyPropertyChanged
	{
		static readonly int[] COLORS = new[] {
				new Android.Graphics.Color(255,0,0,255).ToArgb(), new Android.Graphics.Color(255,0,255,255).ToArgb(), new Android.Graphics.Color(0,0,255,255).ToArgb(),
				new Android.Graphics.Color(0,255,255,255).ToArgb(), new Android.Graphics.Color(0,255,0,255).ToArgb(), new Android.Graphics.Color(255,255,0,255).ToArgb(),
				new Android.Graphics.Color(255,0,0,255).ToArgb()
			};
		...
		Android.Graphics.Color previewColor;
		...
		public ColorPickerView() : base(Forms.Context)
		{
			...
			imageViewPallete.Background = new Android.Graphics.Drawables.GradientDrawable(Android.Graphics.Drawables.GradientDrawable.Orientation.LeftRight, COLORS);
			...
			imageViewPallete.Touch += (object sender, TouchEventArgs e) =>
			{
				...
				{
					currentPoint = new Android.Graphics.Point((int)e.Event.GetX(), (int)e.Event.GetY());
		...
		public Android.Graphics.Color SelectedColor
		{
			get
			{
	...
	public class ColorPointer : Android.Views.View
	{
		Android.Graphics.Paint colorPointerPaint;
		Android.Graphics.Point currentPoint;
